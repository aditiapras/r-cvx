...
const Casestudies3 = ({
  ...
  return (
    <section className="py-32 flex flex-col w-full items-center justify-center">
            ...
            <div className="grid lg:grid-cols-2">
              {casestudies.map((item, idx) => (
                <a
                  key={item.company}
                  href={item.link || "#"}
                  className={`border-border bg-background hover:bg-muted/40 group flex flex-col justify-between gap-12 px-6 py-8 transition-colors duration-500 ease-out md:py-16 lg:pb-16 xl:gap-16 ${idx === 0
                    ? "xl:border-l xl:pl-8"
